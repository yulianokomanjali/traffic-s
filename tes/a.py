...
min_hiegth_react=80 #min higth reactangle
...
while True:
	...
	if cv2.waitKey(1) == 13:
		break
if (counter) >= 2:
	    cv2.putText(frame1,"JALAN LENGANG",(450,140),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
elif (counter) <= 2:
	    cv2.putText(frame1,"JALAN",(450,140),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
